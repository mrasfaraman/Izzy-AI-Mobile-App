        ...
        <View style={{flex: 1}}>
          ...
          <View style={{marginHorizontal: 20, marginTop: 20}}>
            ...
            <View style={{marginTop: 10}}>
              {SessiontypId === 1 ? (
                // If SessiontypId is 1, render list of incorrect pronunciations
                articulationReport
                  .filter(item => item && item.WordText)
                  .map((item, index) => (
                    <Text
                      key={index}
                      style={[
                      ...
                      <Text style={{color: 'red', textTransform: 'uppercase'}}>
                        {item.WordText.charAt(0)}
                      </Text>
                      {item.WordText.substring(1)}
                    </Text>
                  ))
              ) : SessiontypId === 2 ? (
